...
public LiquidContDescr(Cname, Cids, Cshort, Clong, Cweight, Ccapa, 
                       NoClose, Clabel);
...
public LiquidContDescr(Cname, Cids, Cshort, Clong, Cweight, Capa, 
                       NoClose, Clabel)
{
...
public AllowDrinking(no) { return _NoDrinking = no; }

public QueryContents() { return ({ _MaxCapacity-_Capacity, _Fname }); }

public QueryContainer() { return 1; }
