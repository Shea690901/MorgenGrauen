...
//    to_float((hbcount - lasthbcount) * __HEART_BEAT_INTERVAL__);
  ...
  hbdata[index] = debug_info(DINFO_DATA, DID_STATUS, DID_ST_HBEAT_PROCESSED);
  codata[index] = debug_info(DINFO_DATA, DID_STATUS, DID_ST_CALLOUTS);
